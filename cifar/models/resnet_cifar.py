...
def resnet20(tau):
    ...
    """
    model = ResNet(BasicBlock, [3, 3, 3], tau)
    return model
...
def resnet32(tau):
    ...
    """
    model = ResNet(BasicBlock, [5, 5, 5], tau)
    return model
...
def resnet44(tau):
    ...
    """
    model = ResNet(BasicBlock, [7, 7, 7], tau)
    return model
...
def resnet56(tau):
    ...
    """
    model = ResNet(BasicBlock, [9, 9, 9], tau)
    return model
...
def resnet110(tau):
    ...
    """
    model = ResNet(BasicBlock, [18, 18, 18], tau)
    return model
...
def resnet1202(tau):
    ...
    """
    model = ResNet(BasicBlock, [200, 200, 200], tau)
    return model    
